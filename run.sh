...
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/mnist-lenet5.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/mnist-resnetsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/mnist-vggsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/fmnist-lenet5.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/fmnist-resnetsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/fmnist-vggsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/cifar10-lenet5.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/cifar10-resnetsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
JOB_DIR="/home/ubuntu/Deep-Cloud/job/cnn/cifar10-vggsmall.py --optimizer $OPTIMIZER --prof_or_latency $PROF_MODE"
